...
<template>
  <div ref="rootRef">
    <!-- Navigation -->
    <nav ref="navRef" class="fixed inset-x-0 top-0 z-[70] px-5 sm:px-8 lg:px-12 xl:px-16 mt-5">
      <div class="relative mx-auto flex h-20 w-full max-w-full items-center justify-between">
        <!-- 左：Logo -->
        <div ref="brandRef" class="group flex items-center gap-3">
          <div class="flex shrink-0 items-center justify-center">
            <svg width="327" height="140" class="h-auto w-[104px] sm:w-[116px]" viewBox="0 0 327 140" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div class="grid place-items-center">
          ...
          <button ref="hamburgerRef" type="button" :style="menuButtonStyle"
            class="col-start-1 row-start-1 flex h-11 w-[170px] items-center justify-between rounded-sm px-4 outline-none justify-self-end focus-visible:ring-2 focus-visible:ring-[#B55F00] focus-visible:ring-offset-2 sm:w-[200px]"
